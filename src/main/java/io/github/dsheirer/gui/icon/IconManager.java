...
/\*\*
  ...
  * Updated to support modern Windows 11 native styles and SVG prioritization.
    \*/
    ...
    /\*\*
      ...
      * Constructs an instance
        ...
        // Apply Windows 11 native/friendly GUI styling if detected
        if (OSType.getCurrentOSType().isWindows11OrHigher())
        {
        this.getStyleClass().add("windows-11-modern");
        }
        }
    ...
    mAddButton.setMaxWidth(Double.MAX\_VALUE);
    ...
    mEditButton.setMaxWidth(Double.MAX\_VALUE);
    ...
    mDeleteButton.setMaxWidth(Double.MAX\_VALUE);
    ...
    mSetAsDefaultButton.setMaxWidth(Double.MAX\_VALUE);
    ...
    mFileButton.setMaxWidth(Double.MAX\_VALUE);
    mFileButton.setOnAction(event -\> {
    FileChooser fileChooser = new FileChooser();

    ```
             // Updated to prioritize Scalable Vector Graphics (*.svg) for modern GUI environments
             fileChooser.getExtensionFilters().addAll(
                 new FileChooser.ExtensionFilter("Vector Icons (*.svg)", "*.svg"),
                 new FileChooser.ExtensionFilter("Picture Files", "*.png", "*.tif", "*.tiff", "*.gif", "*.jpg", "*.jpeg"),
    ...
    mSaveButton.setMaxWidth(Double.MAX\_VALUE);
    ...
    mCancelButton.setMaxWidth(Double.MAX\_VALUE);
